    ...
    return (
        <div className='footer__bottom-side'>
            <div className='footer__inner-wrapper'>
                <h6 className='footer__bottom-side-title'>Copyright © 2050 all rights reserved</h6>
                ...
                <a className='footer__developer-name' href="https://www.github.com/MohamadMahdi-Tasha">Coded by <span>Abhijeet Chatterjee</span></a>
            </div>
        </div>
    );
}