        ...
        <div className='footer__middle-side'>
            <div className='footer__inner-wrapper'>
                ...
                <ul className='footer__list'>
                    ...
                    <li className='footer__list-item'><a href="#">Returns & Exchanges</a></li>
                    <li className='footer__list-item'><a href="#">Shipping & Delivery</a></li>
                    <li className='footer__list-item'><a href="#">Privacy Policy</a></li>
                </ul>
                <ul className='footer__list'>
                    <li className='footer__list-heading'>CONTACT US</li>
                    <li className='footer__list-item'>
                        <svg width="11" height="11" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className='footer__list-item'>
                        <a href="mailto:imwhdiiii@gmail.com">
                            <svg width="11" height="11" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
