...
export default function ProductPage() {
    ...
    return(
        <PageComponent pageName={'product'}>
            <AlertComponent onClickOfCloseBtn={() => setClickedOfShareBtn(false)}
                            isOpenedProp={isShareButtonClicked}
                            title='The Url Is Copied Tou Your Clipboard!'>
                The Url Is Copied To Your Clipboard <br/>You Can Now Share This With Whoever You Want :)
            </AlertComponent>
            <PageSectionsComponent pageName={'product'} sectionNumber={'first'}>
                <div className='page--product__breadcrumb-holder'>
                    <PageCategoriesBreadCrumbComponent />
                    <button onClick={() => setClickedOfShareBtn(true)}
                            className='page--product__share-btn'>
                ...
                {
                    (isLoaded)
                        ? <h1 className='page--product__product-name'>{info.title}</h1>
                        : <div className='page--product__product-name-loader'></div>
                }
                <div className='page--product__top-product-info'>
                    {
                        (isLoaded)
                            ? <PageProductsItemScoreComponent score={Math.round(info.rating.rate)}/>
                            : <div className='page--product__product-top-rating-loader'></div>
                    }
                    <div className='page--product__product-id-and-ava'>
                        {
                            (isLoaded)
                                ? <h6 className='page--product__product-id'>ID:<span>{info.id}</span></h6>
                                : <div className='page--product__product-id-loader'></div>
                        }
                        <h6 className='page--product__product-ava'>Availability:<span>In Stock</span></h6>
                    </div>
                </div>
            ...
            <PageSectionsComponent pageName={'product'} sectionNumber={'second'}>
                {
                    (isLoaded)
                        ? <img className='page--product__product-img' src={info.image} alt={info.title} />
                ...
                <div className='page--product__product-content'>
                    ...
                    <div className='page--product__product-guaranteed-holder'>
                        ...
                        <div className='page--product__product-guaranteed-line-holder'>
                            <h6 className='page--product__product-guaranteed'>guaranteed safe checkout</h6>
                            <div className='page--product__product-line'></div>
                        </div>
                        <ul className='page--product__product-companys-holder'>
                            <li><img className='page--product__product-companys-img' src={AmericanExpressLogo} alt="AmericanExpress Logo"/></li>
                            <li><img className='page--product__product-companys-img' src={DiscoverLogo} alt="Discover Logo"/></li>
                            <li><img className='page--product__product-companys-img' src={MasterCardLogo} alt="MasterCard Logo"/></li>
                            <li><img className='page--product__product-companys-img' src={VisaLogo} alt="Visa Logo"/></li>
                            <li><img className='page--product__product-companys-img' src={PaypalLogo} alt="Paypal Logo"/></li>
                            <li><img className='page--product__product-companys-img' src={AESLogo} alt="AES Logo"/></li>
                            <li><img className='page--product__product-companys-img' src={StripeLogo} alt="Stripe Logo"/></li>
                        </ul>
                    </div>
                    <div className='page--product__additional-info-holder'>
                        <h6 className='page--product__additional-info'>ADDITIONAL INFORMATION</h6>
                        <ul className='page--product__additional-info-list'>
                            <li className='page--product__additional-info-item'>Color: <span>Blue, White, Black, Grey</span></li>
                            <li className='page--product__additional-info-item'>Size: <span>XS, S, M, L</span></li>
                            <li className='page--product__additional-info-item'>Material: <span>100% Polyester</span></li>
                        </ul>
                    </div>
                    <div className='page--product__product-reviews-holder'>
                        <h6 className='page--product__product-reviews'>REVIEWS</h6>
                        <div className='page--product__product-reviews-score-holder'>
                            <div className='page--product__product-reviews-score'>
                                <PageProductsItemScoreComponent score={4.5}/>
                                <h6 className='page--product__product-reviews-count'><span>2</span>Reviews</h6>
                            </div>
                            <button className='page--product__product-write-review-btn'>
